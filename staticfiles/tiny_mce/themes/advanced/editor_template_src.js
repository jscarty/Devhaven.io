	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_fonts : "Andale Mono=andale mono,times;Arial=Arial,helvetica,sans-sans-serif;Arial Black=Arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-sans-serif;Courier New=courier new,courier;Arial=Arial,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,Arial,helvetica,sans-sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
